...
export const RoadToSilverwood: Scene = {
	...
	text: `The road to Silverwood winds through ancient forests and forgotten valleys. Three days of travel, according to the Guild Master's directions. Three days to contemplate what awaits you.
...
Around the campfire each night, conversations deepen. Bonds strengthen. The weight of what's to come presses on everyone, but there's also hope - the hope that answers finally await.`,
	textVariants: [
		{
			conditions: {
