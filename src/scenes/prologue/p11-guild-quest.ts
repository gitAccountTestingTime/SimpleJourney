...
Sleep came fitfully, interrupted by dreams of glowing crimson light and voices speaking words you couldn't quite understand. When dawn finally broke through the shuttered windows, you felt simultaneously exhausted and eager, like your body knew something important was about to happen.`;

const guildSummons = `The message arrived with breakfast: the Guild Master requests your immediate presence. The wax seal bore the Adventurer's Guild symbol, a compass rose intertwined with a sword, but someone had added a small notation in the corner. A personal summons it seems, as opposed to routine business. The timing seems...convenient. Perhaps too convenient to be coincidence. You prepare yourself for whatever agenda might be at play as you head to the guild hall.`;

const guildMasterOffice = `Upon arrival at the Guild Hall, you are escorted immediately up to the Guild Master's office.

The Guild Master's office occupies the top floor of the guild hall, positioned to overlook both the training yards below and the city streets beyond. Morning light streams through tall windows, illuminating walls covered with maps, contracts, and commendations from grateful clients. The air smells of parchment, ink, and the faint herbal scent of the tea that perpetually steams on her desk.

She stands as you enter, which catches you off-guard. You were not expecting a gesture of respect given the rank difference. Guild Master Lyra Stormwind has run the capital branch for fifteen years, and her reputation is formidable: stern but fair, politically astute, and possessing an uncanny ability to read people.Her silver hair is pulled back in a practical braid, and her eyes, the pale grey of winter storms, study you with obvious intent.`;

const contractOffer = `"I have a contract for you," she says without preamble, her voice carrying the crisp efficiency of someone who respects your time. "Investigate strange occurrences at Silverwood Manor. The local lord abandoned the property five years ago after his family reported... unsettling phenomena. Doors opening on their own, voices in empty rooms, lights appearing in windows of sealed chambers. Typical ghost stories one might think, except these reports have been consistent and corroborated by multiple independent sources over the past year."`;

const manorDetails = `She paces to the window, silhouetted against the morning light. "As you might expect, initially, we dismissed the reports as superstition or attempted insurance fraud. But recently, the phenomena have intensified. Travelers on the nearby roads report hearing music from the manor at night—specifically, a lullaby that hasn't been sung publicly since the Silverwood royals were executed. Local villagers avoid the property entirely now, claiming they've seen figures in the windows wearing royal regalia."`;
...
She leans forward, hands folded on the desk. "I won't pretend ignorance. Whisper contacted me last night, explained your situation, and suggested this contract would serve multiple purposes: guild business, personal discovery, and potentially... preparation for larger challenges ahead. Rare is the day Whisper is mistaken, and I doubt they are wrong now. The choice is yours of course, but I suspect you already know what you need to do."`;
...
Once Guild Master Lyra stood upon your entrance, you noticed that she's not alone. Ash leans against the wall near the window, arms crossed, expression serious. The mercenary captain has been your mentor and ally since you joined the guild, and her presence here suggests this meeting is more significant than routine business.

${contractOffer}

${manorDetails}

Before you can respond, Ash straightens from their casual lean, stepping forward with purpose. "I'm going with them," she states firmly, brooking no argument. "If this is about their heritage, about Silverwood blood and royal magic, they'll need someone watching their back. Someone who knows how to handle threats both mundane and magical."
...
Ash moves closer, studying the seal with a warrior's tactical assessment. "That symbol," she murmurs. "I've seen it before, in old military histories. The Silverwood crest was considered sacred by their house guards...soldiers who swore oaths not to the throne, but to the bloodline itself." She looks at you meaningfully. "If the manor still carries that mark, it might respond to someone with authentic Silverwood blood."`;
			}
		},
		{
			conditions: {
			...
			get text() {
				return `The night after Whisper's revelations passed in a blur of racing thoughts and restless dreams. You found yourself reflecting on everything you've learned, and what your options now were. 
				
				You've grown close to Ash over your time with the guild and with Inferno. The mercenary captain's steady presence and tactical wisdom earning not just your respect, but genuine trust. When you returned from the Undercroft, it was Ash you sought out to share the overwhelming truth: you carry royal blood from an extinct dynasty.
...
Her honesty is disarming, and her respect for your caution feels genuine. "Take time to verify. Ask questions. Proceed carefully. But I suspect you already know what you need to do...and that you know it's the right path despite your doubts."`;
			}
		},
		{
...
You accepted those terms, understanding that in the world of information brokers, everything has a price and debts are currency. Understanding who and what you are felt essential, regardless of future obligations.

The summons from the Guild Master arrived at breakfast, and you suspected immediately this was Whisper's suggested repayment.  They certianly work quickly.

${guildMasterOffice}

Guild Master Lyra greets you with an expression that suggests she's fully aware of the arrangement. Whisper's network clearly extends into official guild channels, their influence reaching even further than you initially realized.
...
She slides a handwritten note bearing Whisper's distinctive, careful script:
...
She pauses, adding quietly, "For what it's worth, I think Whisper genuinely believes this will help you. Their methods are transactional, but their intent isn't malicious. They collect favors, yes...but they also guide people toward their destinies when those paths align with larger purposes."`;
	...
	choices: [
		{
			id: 'eager',
			text: 'Accept immediately and leave as soon as possible. Answers await, but the new threats you must now contend with may not.',
		...
		{
			id: 'prepared',
			text: 'Accept, but take time to properly prepare and gather necessary supplies. Caution is prudent given recent revelations, and you want to be ready for whatever awaits.',
			next: 'road_to_silverwood',
			effects: { wisdom: 1 },
			hiddenEffects: {
		...
		{
			id: 'companions',
			text: 'Accept, but recruit trusted companions before departing. You\'ve made allies, and there is strength in numbers, and power to be found in trusting others.',
			next: 'road_to_silverwood',
			effects: { charisma: 1 },
			hiddenEffects: {
		...
		{
			id: 'questions',
			text: 'Request comprehensive briefing on everything known about Silverwood Manor first. There may not be much time, but knowledge is power.',
			next: 'road_to_silverwood',
			effects: { wisdom: 1 },
			hiddenEffects: {
