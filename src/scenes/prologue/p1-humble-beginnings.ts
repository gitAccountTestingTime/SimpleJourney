...
const oddJobsLife = `For years you've done odd jobs around the village to get by, each day the same as the last. The memories of your life until now swirl somewhere in the back of your mind as you slowly walk through the village, much as you have every day before. You push them aside as you approach the square, which was busier than usual for this time of day.`;
...
const elderAnnouncement = `"Bandits have been raiding the trade routes," the elder announces, his voice carrying across the square. "We've been unable to get word to any of the adventurer's guilds in the area, and with how low our current remaining supplies are...the village is running out of options. We need brave souls to deal with them. Payment will be fair."`;

const situationRealization = `You'd heard rumors of supplies being intercepted and taken before reaching the village, but did not know that things had gotten this bad. This no doubt will spell trouble for you.  As someone who has always been a loner, living on the outskirts of the village, not really associating with anyone, you'll be one of the first to truly feel the squeeze as supplies dwindle.

On the other hand, this could be your chance to prove yourself, or to actually earn enough coin to finally leave this place. Regardless, as someone already living day to day, you can hardly sit around and hope someone else resolves the situation.`;
