...
const undercroftDescription = `The Undercroft. Even the name carries weight in the capital's underworld, spoken in hushed tones by those who know better than to raise their voices. This labyrinthine network of tunnels sprawls beneath the city like a secret second world, covered in ancient catacombs, smuggler's highways, and neutral ground where the city's information brokers conduct their shadowy business.

The air down here tastes of damp stone and old secrets. Flickering torches cast dancing shadows on walls carved with symbols you don't recognize. As far as you can tell, some appear to be territorial markers, others warnings, still others prices for services rendered. The darkness between the pools of firelight seems deeper than natural, almost as if the shadows themselves have substance.

Distant echoes suggest these tunnels likely extend far beyond what you can see. Around every corner and down every alley you hear voices murmuring in alcoves, footsteps hurrying through unseen passages, or the occasional splash of water from underground streams. This is a place where the capital's true power brokers meet, where deals are struck that will never see daylight, where information changes hands for prices measured in coin, favors, or blood.`;

const valeGuidance = `Vale led you here after your magical awakening, his usual confidence tempered by unusual gravity. The revelation of your blood magic heritage clearly changed something. Perhaps not his loyalty, but at least his understanding of the stakes involved.

"Whisper knows things," Vale had said as you descended into the tunnels. "Things that aren't written in histories or stored in royal archives. The kind of knowledge that gets people killed if they're not careful about how they use it." He paused at a junction, checking the symbols carved into the stone before choosing a path. "If anyone can help you understand what you're becoming, what you've always been, it's them."`;

const whisperEntrance = `The figure emerges from the shadows with such complete silence that you don't notice their presence until they're standing directly beside you. It's unnerving. It wasn't not magical teleportation or supernatural speed, but rather a perfect mastery of stealth that speaks to years of practice moving unseen through dangerous places.

The person before you is deliberately androgynous, their features carefully neutral, voice pitched to reveal nothing, clothing designed to obscure rather than define. Dark garments seem to absorb the torchlight rather than reflect it, rendering them a living shadow even in the flickering glow. But it's the eyes that capture your attention: sharp, calculating, and deeply intelligent. Eyes that have witnessed countless secrets and judged countless souls. Eyes that miss absolutely nothing.`;

const whisperIntroduction = `"So," a soft voice observes, each word precisely enunciated with an accent you can't quite place...or more likely is deliberately obscured. "The lost royal finally awakens. How delicious."
...
"You need allies who understand what you're facing," Vale explained. "People who've dealt with blood magic, who know the history and the dangers. Rook has connections in the Undercroft, I'll start by reaching out to him."
...
"There's someone you need to meet," they insisted. "Someone who understands blood magic and the politics surrounding it. They can help you navigate what comes next."  With that as his entire description, Vale led you away from the arena and into the winding tunnels of the Undercroft.
...
"Small world, isn't it?" they reply with a knowing smile. "Or maybe just good timing. Whisper sent word they'd be receiving an important guest of some kind. Didn't realize it would be you."
...
"Whisper's the real deal," Rook says quietly as he leads the two of you deeper into the Undercroft. "Knows more secrets than anyone else in the capital. If you can trust anyone with dangerous information, it's them."

${whisperEntrance}

Rook surprises you with a gesture of deference you were not expecting, given his usual irrevernt attitude, and bows his head slightly. 

"So," a soft voice observes, "the lost royal finally awakens. How delicious." Those knowing eyes study you with unnerving intensity before shifting to Rook. "And our young friend has already formed an attachment. Most interesting."

They return their full attention to you. "I am Whisper. I deal in secrets, truths, and the occasional convenient lie. Your blood is... interesting. Rook tells me you can be trusted, which carries considerable weight with me. Few earn his loyalty." A pause, weighted with significance. "Let us discuss what your heritage truly means. And perhaps more importantly, how to ensure it doesn't become your death sentence."`;
			}
		},
		{
...
"You need answers," Vale said as they guided you down into the Undercroft. "And you need them quickly, before the fear consumes you completely. Whisper can help. They've dealt with blood magic before; studied it, protected practitioners, even helped them understand their gifts."
...
"I am Whisper," they continue, their tone deliberately calm and non-threatening. "Your terror is understandable, truly. The blood magic of the Silverwood line is powerful and dangerous, and you've been thrust into this reality without preparation or choice. But hear me: what you possess is a gift, not a curse. It can be controlled, understood, and used for remarkable good."
...
Vale watched your transformation from shock to analytical interest with visible relief. "You're taking this remarkably well," he observed.
...
"Good," Vale said with an approving smile, though it was clear he wasn't fully at ease. "Because I know someone who has answers. Whisper deals in rare knowledge...the kind that's been suppressed or forgotten. If anyone can explain blood magic comprehensively, it's them."

Vale quickly leads you out of the arena, and towards a place he called the Undercroft. ${undercroftDescription}
...
"You'd fit right in down here," Vale said with amusement. "Always analyzing, always seeking patterns."  The two of you came to a stop before a secluded alcove where multi-colored torchlight flickered against stone walls.
...
Those knowing eyes gleam with what might be approval as they study your expression while noting, you suspect, the curiosity rather than fear or greed reflected there.
...
They gesture to a nearby table where ancient books and scrolls lie carefully arranged. "Your curiosity will serve you well in the days ahead. The Silverwood magic is complex, dangerous, and poorly understood by modern scholars, likely because most of them have never even seen it, let alone experienced it firsthand. But I have studied it extensively." A pause, weighted with promise. "Let us discuss what your blood truly means. The mechanics, the history, the theoretical frameworks, and most importantly, what it could become with proper understanding and practice."`;
	...
	choices: [
		{
			id: 'direct',
			text: '"Let us get straight to the point: tell me everything you know about my bloodline, and what it means for me now."',
		...
		{
			id: 'trade',
			text: '"What do you want in exchange for this information? I may be ignorant about how things work down here, but I know `free` is often the most expensive price of all."',
			next: 'guild_masters_request',
			effects: { charisma: 2 },
			hiddenEffects: {
		...
		{
			id: 'charm',
			text: '"Perhaps we could help each other. Allies are valuable in dangerous times, and it seems we both have... unique skills to offer."',
			next: 'guild_masters_request',
			effects: { charisma: 3 },
			hiddenEffects: {
