...
export const ClimaxPreparation: Scene = {
	...
	text: `With the Crystal Heart restored and all five magical races aligned with you, the moment of truth approaches. In the grand council chamber, representatives of every faction - human and magical - gather for the final decision.

The kingdom stands at a crossroads. Loyalists demand traditional monarchy. Reformists push for democratic revolution. The military wants strong centralized control. And you've proven that magical races deserve a voice too.

Seraphine speaks for tradition. Sage argues for democracy. Kieran represents military concerns. Lyra advocates for magical race inclusion. Each companion you've bonded with looks to you, trusting your wisdom.

The choice you make now will define not just your reign, but the future of the entire realm for generations to come.`,
	textVariants: [
		{
			conditions: {
...
The tension is palpable, but so is the hope. You have the chance to create something truly revolutionary - if you can unite these disparate voices into one vision.`
		...
		{
			conditions: {
				hasHiddenAttributes: { shadow_magic_learned: true, corruption_risk: 3 }
			},
...
export const UnitySpeech: Scene = {
	id: 'unity_speech',
	text: `You step forward, and the entire chamber falls silent. Every eye - human, elven, dwarven, draconic, fae, and merfolk - watches you. This is the moment that will define your legacy.

"For centuries," you begin, your voice carrying through the hall, "we've been divided. Humans fought humans. Magical races isolated themselves from mortals. Factions within factions, each claiming their way was the only way."

You look around the chamber, meeting eyes both familiar and strange. "But I've walked among all of you. I've earned the trust of magical races through respect, not dominance. I've seen the best of every faction's vision. And I know, in my bones, that none of us can build the future alone."

Murmurs ripple through the crowd - some approving, some skeptical.

"I propose a new system," you continue. "Constitutional monarchy with an elected council. Military reformed to serve all people equally. And - this is crucial - magical races given equal representation. Not as subjects, but as partners."

The room explodes in debate. Some cheer. Others object loudly. The success of this vision depends on everything you've built - every relationship, every choice, every bridge between worlds.`,
	choices: [
		{
			id: 'passionate-plea',
...
export const PersonalSacrifice: Scene = {
	...
	text: `As debate rages, a voice cuts through the chaos. It's Elena, leader of the common people's movement, who you encountered in the underground network.
...
The question hangs in the air. She's right - true leadership requires sacrifice. The assembly waits for your answer.

Your companions watch with varied expressions. Your romance partner, if you have one, looks concerned - they know what this might cost.

"Power demands price," an ancient voice - the Dragon Matriarch - agrees. "Show us you're worthy of the trust we place in you."`,
	textVariants: [
		{
			conditions: {
